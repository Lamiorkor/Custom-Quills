...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($user_id && $user_name && $user_email && $password) {
        if ($_SESSION['user_role'] === 'administrator') {
            $result = updateUserController($user_id, $user_name, $user_email, $password, $user_role, $country, $city, $phone_number);

            if ($result) {
                $_SESSION['success_message'] = "Profile updated successfully.";
                header('Location: ../admin_view/admin_user_profile.php');
                exit();
            } else {
            ...
            if ($result && $role_result) {
                ...
                header('Location:../customer_view/customer_user_profile.php');
                exit();
            } else {
            ...
            if ($result && $role_result) {
                ...
                header('Location: ../writer_view/writer_user_profile.php');
                exit();
            } else {
